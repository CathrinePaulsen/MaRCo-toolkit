...
from core import get_available_versions, scrape_available_versions, namespace, GAV, unroll_range
from core.config import M2_PATH
...
class Node:
    ...
    def __parse_omitted(self):
        if DUPLICATE_LINE in self.raw:
            ...
            managed_from = self.raw[index + len(MANAGED_LINE) : -2].split(";")[0]
