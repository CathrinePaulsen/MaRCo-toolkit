...
class Template(ABC):
    ...
    @abstractmethod
    def __init__(self, g: str, a: str, v: str, repo_storage_path="", pom_path="", repo_name="", tag_name="", commit_sha="", use_local=False):
        self.group_id = g
        self.artifact_id = a
        self.version = v
        self.gav = f"{g}:{a}:{v}"
        ...
        elif not use_local and not self.template_exists():  # Get repo from pom
